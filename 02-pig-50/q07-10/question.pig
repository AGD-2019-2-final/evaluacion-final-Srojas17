...
datos_mape= FOREACH rank_datos GENERATE rank_datos, letra, FLATTEN(mape) as f_mape;
DUMP datos_mape;

agrupa_mape = group datos_mape by rank_datos;
DUMP agrupa_mape;

conteo_mape = FOREACH agrupa_mape GENERATE group,  COUNT(datos_mape);
DUMP conteo_mape;

join_1 = JOIN conteo_bolsa by $0 , conteo_mape by $0;
